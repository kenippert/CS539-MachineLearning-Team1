...
print('Predicted Y Values', diabetes_progression_pred1)
print('True Y Values', diabetes_y)
...
LRR2score = r2_score(diabetes_y_test, diabetes_progression_pred1)
print('R2 Score: \n %.2f ' %LRR2score)


clf1 = svm.SVC(kernel='linear', C=1, random_state=42).fit(diabetes_X_train, diabetes_y_train)
scores1 = cross_val_score(clf1, diabetes_X_test, diabetes_y_test, cv=2)
